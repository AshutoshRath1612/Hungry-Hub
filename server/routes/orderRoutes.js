...
const { createOrder, addOrder, getUserOrders, getCurrentOrders, getAllOrders, updateOrderStatus, todayOrder, getMostOrder } = require('../controller/orderController');
...
router.get('/popular-orders/:id' , getMostOrder)
